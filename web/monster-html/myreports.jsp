<%-- 
    Document   : myreports
    Created on : Mar 26, 2019, 12:30:33 AM
...
<body class="fix-header card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="myreports.jsp">
                        <!-- Logo icon -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Your Reports</h3>
                        <ol class="breadcrumb">
                            ...
                            <div class="card-block">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table class="table stylish-table">
                                        <thead>
                                            <tr>
                                                <th colspan="2">Recent Reports</th>
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer text-center"> © 2019 DoctorsOnClick</footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
        </div>
