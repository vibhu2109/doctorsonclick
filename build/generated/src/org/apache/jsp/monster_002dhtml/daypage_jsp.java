...
public final class daypage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
            ...
            Connection con = DBConnection.DBConnection.getconnection();
              Statement  stmt = con.createStatement();
                 ResultSet rs1=stmt.executeQuery("select * from doctors where did='"+did+"'");
                   ...
                   //out.print(date);
                   java.sql.Date date2=new java.sql.Date(millis+600000000);
                   //out.print(date2);
                    Date current = date;
                    ...
                    int cnt=19;
                     ...
                     while (current.before(date2)) {
                            ...
                            if(rs1.getString(cnt)!=null && rs1.getString(cnt).length()!=0){
      ...
      out.write("         \n");
      out.write("  \n");
      out.write("        <!-- <button style=\"width:auto; top:0px;\"> <a href=\"getslot.jsp?id=");
